    ...
    <section class="content">
      ...
      <div class="box box-primary col-md-4">
            ...
            <?php if($this->session->flashdata('msg_erreur') ): ?>
                ...
                <?php endif ?>
            <form action ="<?php echo base_url().'index.php/Controlleruser/SaveUser' ?>" method="post" role="form">
              <div class="box-body ">
                <div class="col-md-8 frm">
                <div class="form-group">
                    <label class="col-md-4 control-label">Immatriculation</label>
                    <div class="col-md-8">
              ...
              <div class="col-md-8 frm">
                <div class="form-group">
                    <label class="col-md-4 control-label">Nombre de place</label>
                    <div class="col-md-8">
                        <div class="input-group">
                            <input type="number" id="nbr_place" name ="nbr_place" class="form-control" value=''> 
                            <span class="input-group-addon">
                            <i class="fa fa-envelope"></i>
                            </span>
                        </div>
