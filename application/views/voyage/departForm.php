...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="cantainer">
            <div class="row ">
                <form class="col-md-9 col-md-offset-2 " style="margin-top:5%;" method="post" role="" id="form_client" action="<?php echo base_url() . 'index.php/Voyage/save_depart' ?>">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="col-md-12 m-t-10 " id="">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <div class="option-group">
                                            <input required class="form-control  form-white" type="text" id="date_depart"
                                                   name="date_depart"/>
                                        </div>
                                    </div>
                                </div>
