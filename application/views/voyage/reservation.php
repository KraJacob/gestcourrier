...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form action="<?php echo base_url() . 'index.php/Voyage/add_reservation' ?>" onSubmit="return valid_form()"
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        ...
                                        <div class="row" style="margin-bottom:2%;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                <input class="forms" name="date_depart" type="text"
                                                                       required value="" id="date_reservation" readonly
                                                                       placeholder="date du depart">
                                            ...
                                            <div class="col-md-2">
                                                <input name="type_passager" id="normal" value="normal" checked="checked"
                                                       type="radio">Normal
                                            </div>
                                            <div class="col-md-2">
                                                <input name="type_passager" id="privilegie" value="privilegie"
                                            ...
                                            <div class="col-md-6">
                                                <div class="col-md-12 frm" style="margin-bottom:1%;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                <input class="forms" name="nom" type="text" required
                                                                       value="" id="nom_reservation"
                                                ...
                                                <div class="col-md-12 frm" style="margin-bottom:1%;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                <input type="text" id="prenom_reservation" name="prenom"
                                                                       required class="forms" value=''
                                                                       onChange="majuscule(this);">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-12 frm" style="margin-bottom:1%;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                <input type="text" id="mobile_reservation" name="mobile"
                                                                       required class="forms" value=''>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-12 frm" style="margin-bottom:1%;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                <input type="text" id="num_depart" required
                                                                       name="num_depart" class="forms">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 frm" style="margin-bottom:1%;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                <input type="text" id="siege" required name="num_siege"
                                                                       class="forms">
                                                            </div>
                                                            <div id="tooltip"
