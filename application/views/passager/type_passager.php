...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       ENREGISTREMENT DU TYPE DE PASSAGER
    ...
    <section class="content">
      ...
      <div class="box box-primary col-md-4">
            ...
            <?php if($this->session->flashdata('msg_erreur') ): ?>
                ...
                <?php endif ?>
            <form action ="<?php echo base_url().'index.php/ControllerPassager/add' ?>" method="post" role="form">
              <div class="box-body ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group">
                            <input type="text" id="type" name ="lib_type" class="form-control" value=''> 
