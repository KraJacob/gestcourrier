    ...
    <section class="content">
      ...
      <div class="box box-primary col-md-4">
            ...
            <?php if($this->session->flashdata('msg_erreur') ): ?>
                ...
                <?php endif ?>
            <form action ="<?php echo base_url().'index.php/ControllerPersonnel/add_gare' ?>" method="post" role="form">
              <div class="box-body ">
                <div class="col-md-8 frm">
                <div class="form-group">
                    <label class="col-md-4 control-label">Nom de la gare</label>
                    <div class="col-md-8">
                        <div class="input-group">
                            <input type="text" id="type" name ="lib_gare" class="form-control" value=''> 
